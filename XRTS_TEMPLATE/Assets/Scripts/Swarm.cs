...
public class Swarm : MonoBehaviour
{
    ...
    Transform m_goal; //"Targeted" Transform the enemy is trying to move towards

    public Vector2 m_velocity; //Speed and direction of the enemy

    public EnemyAIData m_data;

    Collider2D m_collider; //Collider of the enemy

    Motor m_motor; //Motor of the enemy

    AnimatedCharacterSprite m_sprite; //Sprite animator of the enemy
    ...
    void Update()
    {
        ...
        Vector2 alignment = (GetMeanVelocity(GetAINeighbors()).normalized) * m_data.m_neighbor_align_multiplier; //Alignment, try to align direction with the average direction of nearby agents
